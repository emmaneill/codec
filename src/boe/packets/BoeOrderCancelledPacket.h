 ...
 */
#ifndef _BOE_ORDERCANCELLED_PACKET_H_
#define _BOE_ORDERCANCELLED_PACKET_H_
...
public:
    ...
    uint8_t getCancelReason ()
    {
        return mCancelReason;
    }

    bool setCancelReason (uint8_t val)
    {
        mCancelReason = val;
        return true;
    }
