 ...
 */
#ifndef _BOE_ORDERRESTATED_PACKET_H_
#define _BOE_ORDERRESTATED_PACKET_H_
...
public:
    ...
    bool setRestatementReason (uint8_t val)
    {
        mRestatementReason = val;
        return true;
    }
