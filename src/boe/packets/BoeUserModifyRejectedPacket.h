 ...
 */
#ifndef _BOE_USERMODIFYREJECTED_PACKET_H_
#define _BOE_USERMODIFYREJECTED_PACKET_H_
...
public:
    ...
    boeUserModifyRejectedPacket ()
    {
        mTransactTime = 0;
        memset (mClOrdID, 0, 20);
        mModifyRejectReason = 0;
        memset (mModifyRejectText, 0, 60);
    ...
    uint8_t getModifyRejectReason ()
    {
        return mModifyRejectReason;
    }

    bool setModifyRejectReason (uint8_t val)
    {
        mModifyRejectReason = val;
        return true;
    }
    ...
    bool setModifyRejectText (const string& val)
    {
        return setString (mModifyRejectText, val, sizeof (mModifyRejectText));
    }
