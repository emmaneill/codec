 ...
 */
#ifndef _BOE_TRADECANCELCORRECT_PACKET_H_
#define _BOE_TRADECANCELCORRECT_PACKET_H_
...
public:
        ...
        uint64_t mOrderID;
        uint64_t mExecRefID;
        uint8_t mTradeCancelCorrectSide;
        char mTradeCancelCorrectBaseLiquidityIndicator[1];
        char mTradeCancelCorrectClearingFirm[4];
        char mTradeCancelCorrectClearingAccount[4];
        uint32_t mTradeCancelCorrectLastShares;
        uint64_t mLastPx;
    ...
    boeTradeCancelCorrectPacket ()
    {
        ...
        mOrderID = 0;
        mExecRefID = 0;
        mTradeCancelCorrectSide = 0;
        memset (mTradeCancelCorrectBaseLiquidityIndicator, 0, 1);
        memset (mTradeCancelCorrectClearingFirm, 0, 4);
        memset (mTradeCancelCorrectClearingAccount, 0, 4);
        mTradeCancelCorrectLastShares = 0;
        mLastPx = 0;
        mCorrectedPrice = 0;
    ...
    uint8_t getTradeCancelCorrectSide ()
    {
        return mTradeCancelCorrectSide;
    }

    bool setTradeCancelCorrectSide (uint8_t val)
    {
        mTradeCancelCorrectSide = val;
        return true;
    }
    
    string getTradeCancelCorrectBaseLiquidityIndicator ()
    {
        return getString (mTradeCancelCorrectBaseLiquidityIndicator, sizeof (mTradeCancelCorrectBaseLiquidityIndicator));
    }

    bool setTradeCancelCorrectBaseLiquidityIndicator (const string& val)
    {
        return setString (mTradeCancelCorrectBaseLiquidityIndicator, val, sizeof (mTradeCancelCorrectBaseLiquidityIndicator));
    }
    
    string getTradeCancelCorrectClearingFirm ()
    {
        return getString (mTradeCancelCorrectClearingFirm, sizeof (mTradeCancelCorrectClearingFirm));
    }

    bool setTradeCancelCorrectClearingFirm (const string& val)
    {
        return setString (mTradeCancelCorrectClearingFirm, val, sizeof (mTradeCancelCorrectClearingFirm));
    }
    
    string getTradeCancelCorrectClearingAccount ()
    {
        return getString (mTradeCancelCorrectClearingAccount, sizeof (mTradeCancelCorrectClearingAccount));
    }

    bool setTradeCancelCorrectClearingAccount (const string& val)
    {
        return setString (mTradeCancelCorrectClearingAccount, val, sizeof (mTradeCancelCorrectClearingAccount));
    }
    
    uint32_t getTradeCancelCorrectLastShares ()
    {
        return mTradeCancelCorrectLastShares;
    }

    bool setTradeCancelCorrectLastShares (uint32_t val)
    {
        mTradeCancelCorrectLastShares = val;
        return true;
    }
    ...
    bool setOrigTime (const string& val)
    {
        return setString (mOrigTime, val, sizeof (mOrigTime));
    }
