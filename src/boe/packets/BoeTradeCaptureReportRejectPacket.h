...
public:
        ...
        uint8_t mTradeCaptureRejectReason;
    ...
    uint8_t getTradeCaptureRejectReason ()
    {
        return mTradeCaptureRejectReason;
    }

    bool setTradeCaptureRejectReason (uint8_t val)
    {
        mTradeCaptureRejectReason = val;
        return true;
    }
    
    string getTradeCaptureRejectText ()
    {
