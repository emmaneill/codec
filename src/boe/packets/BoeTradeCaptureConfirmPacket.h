 ...
 */
#ifndef _BOE_TRADECAPTURECONFIRM_PACKET_H_
#define _BOE_TRADECAPTURECONFIRM_PACKET_H_
...
PACKED(class boeTradeCaptureConfirmPacket
{
public:
        uint64_t mTransactTime;
        char mTradeReportID[20];
        char mTradeCaptureTradeReportRefID[20];
        char mTradeID[8];
        uint32_t mTradeCaptureLastShares;
        uint64_t mLastPx;
    ...
    boeTradeCaptureConfirmPacket ()
    {
        mTransactTime = 0;
        memset (mTradeReportID, 0, 20);
        memset (mTradeCaptureTradeReportRefID, 0, 20);
        memset (mTradeID, 0, 8);
        mTradeCaptureLastShares = 0;
        mLastPx = 0;
    ...
    string getTradeCaptureTradeReportRefID ()
    {
        return getString (mTradeCaptureTradeReportRefID, sizeof (mTradeCaptureTradeReportRefID));
    }

    bool setTradeCaptureTradeReportRefID (const string& val)
    {
        return setString (mTradeCaptureTradeReportRefID, val, sizeof (mTradeCaptureTradeReportRefID));
    }
    ...
    uint32_t getTradeCaptureLastShares ()
    {
        return mTradeCaptureLastShares;
    }

    bool setTradeCaptureLastShares (uint32_t val)
    {
        mTradeCaptureLastShares = val;
        return true;
    }
