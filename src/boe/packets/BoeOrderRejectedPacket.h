 ...
 */
#ifndef _BOE_ORDERREJECTED_PACKET_H_
#define _BOE_ORDERREJECTED_PACKET_H_
...
public:
    ...
    boeOrderRejectedPacket ()
    {
        mTransactTime = 0;
        memset (mClOrdID, 0, 20);
        memset (mOrderRejectReason, 0, 1);
        memset (mOrderRejectText, 0, 60);
    ...
    bool setOrderRejectReason (const string& val)
    {
        return setString (mOrderRejectReason, val, sizeof (mOrderRejectReason));
    }
    ...
    bool setOrderRejectText (const string& val)
    {
        return setString (mOrderRejectText, val, sizeof (mOrderRejectText));
    }
