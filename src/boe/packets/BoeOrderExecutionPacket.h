 ...
 */
#ifndef _BOE_ORDEREXECUTION_PACKET_H_
#define _BOE_ORDEREXECUTION_PACKET_H_
...
public:
        ...
        char mClOrdID[20];
        uint64_t mExecID;
        uint32_t mOrderExecLastShares;
        uint64_t mLastPx;
        uint32_t mOrderExecLeavesQty;
        char mOrderExecBaseLiquidityIndicator[1];
        char mOrderExecSubLiquidityIndicator[1];
    ...
    boeOrderExecutionPacket ()
    {
        ...
        mExecID = 0;
        mOrderExecLastShares = 0;
        mLastPx = 0;
        mOrderExecLeavesQty = 0;
        memset (mOrderExecBaseLiquidityIndicator, 0, 1);
        memset (mOrderExecSubLiquidityIndicator, 0, 1);
    ...
    uint32_t getOrderExecLastShares ()
    {
        return mOrderExecLastShares;
    }

    bool setOrderExecLastShares (uint32_t val)
    {
        mOrderExecLastShares = val;
        return true;
    }
    ...
    uint32_t getOrderExecLeavesQty ()
    {
        return mOrderExecLeavesQty;
    }

    bool setOrderExecLeavesQty (uint32_t val)
    {
        mOrderExecLeavesQty = val;
        return true;
    }
    
    string getOrderExecBaseLiquidityIndicator ()
    {
        return getString (mOrderExecBaseLiquidityIndicator, sizeof (mOrderExecBaseLiquidityIndicator));
    }

    bool setOrderExecBaseLiquidityIndicator (const string& val)
    {
        return setString (mOrderExecBaseLiquidityIndicator, val, sizeof (mOrderExecBaseLiquidityIndicator));
    }
    
    string getOrderExecSubLiquidityIndicator ()
    {
        return getString (mOrderExecSubLiquidityIndicator, sizeof (mOrderExecSubLiquidityIndicator));
    }

    bool setOrderExecSubLiquidityIndicator (const string& val)
    {
        return setString (mOrderExecSubLiquidityIndicator, val, sizeof (mOrderExecSubLiquidityIndicator));
    }
